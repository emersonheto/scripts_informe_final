...
OBJETIVO: Muestra en el MEMORANDUM la nota del curso espec�fico para el que se crea el documento.
MODIFICACIONES:
NRO					FECHA					USUARIO					MODIFICACION
====================================================================================================*/

CREATE PROCEDURE [dbo].[sp_CursoMemoFinalReportAp] 
(
    ...
    BEGIN TRY
        ...
        AND EXISTS (
             ...
             WHERE
                 ...
                 AND NVL(T2.ESTADO_ASIGNATURA, ''''Desaprobado'''') = ''''Desaprobado''''
        )
        ORDER BY
            T1.ASIGNATURA
        ''

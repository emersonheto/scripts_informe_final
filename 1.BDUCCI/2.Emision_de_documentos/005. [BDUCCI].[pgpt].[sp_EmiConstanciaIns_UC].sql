...
3		03/06/2025	Emerson Herrera(Waytech)		Se agrega un nuevo tipo de constancia [9] para certificaci�n progresiva de programas de maestr�as.	
4       22/09/2025  Emerson Herrera(Waytech)		Se agrega el par�metro iddocumentofinalreportap para la inserci�n.
======================================================================================================================== */
